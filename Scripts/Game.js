...
class Hero {
  constructor(canvas_w, canvas_h) {
    ...
    document.addEventListener("keydown", (e) => {
      if (e.code === "ArrowLeft") this.side = 0;
      else if (e.code === "ArrowRight") this.side = 1;
    });
    this.options = document.querySelectorAll(".option1");
   this.options[0].addEventListener("click", () => this.side=0);
   this.options[1].addEventListener("click", () => this.side=1);
